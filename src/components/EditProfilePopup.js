...
function EditProfilePopup({isOpen, onClose, onUpdateUser}) {
    ...
    return (
        <PopupWithForm name='editProfile' title='Редактировать профиль' value='Сохранить' isOpen={isOpen} onClose={onClose} onSubmit={handleSubmit}> {/* попап редактирования профиля */}
